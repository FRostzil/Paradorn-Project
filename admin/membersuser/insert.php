<?php
					...
					if(isset($_POST) && !empty($_POST)){ 
						...
						$phone = $_POST['phone'];
						if(!empty($user)){
							$sql_check = "SELECT * FROM memberuser WHERE member_username = '$user'";
							...
							echo $alert;
								...
								$sql = "INSERT INTO memberuser (member_firstname,member_lastname,member_email,member_phone,member_username,member_password,member_images) 
						    ...
						    <div class="app-card-body">
								...
								<div class="mb-3">
								    ...
								    <div class="mb-2 col-lg-6">
									    ...
									    <input type="text" class="form-control" name="user" placeholder="ชื่อผู้ใช้ : member" autocomplete="off" required>
									</div>
