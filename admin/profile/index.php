<?php 
    ...
    $sql = "SELECT * FROM adminuser WHERE admin_user = '$user'";
    ...
    if(isset($_POST) && !empty($_POST)){ 
        ...
        $sql = "UPDATE adminuser SET admin_firstname = '$firstname',admin_lastname = '$lastname',admin_email = '$email',admin_phone = '$phone',admin_image ='$filename' WHERE admin_user = '$user'";                    	
           if (mysqli_query($conn, $sql)) {
            $_SESSION['adminprofiles'] = $filename;
...
/*                 echo '<pre>';
                ...
                if(isset($oldpassword) && !empty($oldpassword)){
                    $sql_check = " SELECT * FROM adminuser WHERE admin_user = '$user' AND admin_pass = '$oldpassword'";
                    ...
                    if($row_check == 0){
                        ...
                        exit();
                            ...
                            $sql = "UPDATE adminuser SET admin_pass = '$newpassword' WHERE admin_user = '$user'";
                            if(mysqli_query($conn,$sql)) {
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
										    ...
										    <div class="item-data"><img id ="preview" class="profile-image rounded-circle" src="upload/admin/<?=$_SESSION['adminprofiles']?>" alt=""></div>
									    </div><!--//col-->
							    ...
							    <div class="item py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="">
									        ...
									        <div class="item-data" mb-2><input type="text" class="form-control" name="firstname" value="<?=$result['admin_firstname']?>"></div>
									    </div><!--//col-->
							    ...
							    <div class="item py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="">
									        ...
									        <div class="item-data"><input type="text" class="form-control" name="lastname" value="<?=$result['admin_lastname']?>"></div>
									    </div><!--//col-->
							    ...
							    <div class="item py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="">
									        ...
									        <div class="item-data"><input type="text" class="form-control" name="phone" value="<?=$result['admin_phone']?>">
									        </div>
									    </div><!--//col-->
							    ...
							    <div class="item py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="">
									        ...
									        <div class="item-data"><input type="text" class="form-control" name="email" value="<?=$result['admin_email']?>">
