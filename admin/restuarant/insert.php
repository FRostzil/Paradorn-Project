					...
					if($row_check > 0){
						...
						if (isset($_FILES['image']['name']) && !empty($_FILES['image']['name'])){
							...
							if(in_array($ext,$extention)){
								...
								$alert .= 'window.location.href = "?page=restaurant&function=add";';
								$alert .= '</script>';
								exit();
					echo $alert;
				}
							...
							$filename = '';
								...
								$sql = "INSERT INTO restuarant (type_restuarant_id,restuarant_name,restuarant_detail,restuarant_phone,restuarant_address,RLAT,RLNG,restuarant_image,restuarant_username) 
								VALUES('$travelling_type_id','$restuarant_name','$restuarant_detail','$restuarant_phone','$restuarant_address','$RLAT','$RLNG','$filename','{$_SESSION["adminlogin"]}')";
						    ...
						    <div class="app-card-body">
								...
								<div class="mb-3">
									...
									<div class="mb-3 col-lg-6">
									    ...
									    <input type="text" class="form-control" name="LAT" placeholder="ที่อยู่อาหาร :"
										autocomplete="off" required>
										</div>

										<div class="mb-3 col-lg-6">
									    <label class="form-label">ลองติจูต</label>
									    <input type="text" class="form-control" name="LNG" placeholder="ที่อยู่อาหาร :"
										autocomplete="off" required>
										</div>		
