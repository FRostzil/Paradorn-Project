...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			echo "Swal.fire({
				...
				if(result){
					window.location.href = '?page=hotel&function=add';
				}
			  })";
			echo "</script>";
								exit();
							...
							$filename = '';
								...
								VALUES('$travelling_type_id','$hotel_name','$hotel_details','$hotel_Price','$hotel_address','$hotel_Phone','$HLAT','$HLNG','$filename','{$_SESSION["memberlogin"]}')";
						    ...
						    <div class="app-card-body">
								...
								<div class="mb-3">
									...
									<div class="mb-3 col-lg-6">
									    ...
									    <input type="text" class="form-control" name="hotel_Price" placeholder="ราคาใส่เฉพาะตัวเลขเท่านั้น : 1000 เป็นต้น"
										autocomplete="off" required>
									</div>

									<div class="mb-3 col-lg-6">
									    <label class="form-label">เบอร์ติดต่อ</label>
									    <input type="text" class="form-control" name="hotel_Phone" placeholder="เบอร์ห้องพัก : 1234567890"
										autocomplete="off" required>
									</div>		
									...
									<div class="mb-3 col-lg-6">
									    ...
									    <input type="text" class="form-control" name="hotel_address" placeholder="ที่อยู่:"
										autocomplete="off" required>
									</div>
